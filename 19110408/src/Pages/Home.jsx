                 ...
                 <div className="">
                     <div className="card-title p-2 d-flex flex-row">
                        <div className="w-25">{item.title}</div>
                         <div className="ms-5">
                             <Link to={`/blog/${item.id}`} className="me-1 btn btn-info btn-sm">View</Link>      
                             <button className="me-1 btn btn-danger btn-sm" onClick={()=>hanleRemove(item.id)}>Delete</button>
                             <Link to={`/blog/${item.id}/updateFrom`} className="btn btn-secondary btn-sm">Repair</Link>
                         </div>
                     </div>
                 </div>
             </div>
